...
export const userService = {
  ...
  updateProfile: (data: any) => apiRequest(API_ENDPOINTS.USERS.PROFILE, {
    method: 'PUT',
...
export const jobService = {
  ...
  createJob: (data: any) => apiRequest(API_ENDPOINTS.JOBS.CREATE, {
    method: 'POST',
    body: JSON.stringify(data),
  }),
};
...
export const blogService = {
  ...
  createBlog: (data: any) => apiRequest(API_ENDPOINTS.BLOGS.CREATE, {
    method: 'POST',
    body: JSON.stringify(data),
  }),
};
...
export const eventService = {
  ...
  createEvent: (data: any) => apiRequest(API_ENDPOINTS.EVENTS.CREATE, {
    method: 'POST',
    body: JSON.stringify(data),
  }),
...
export const messageService = {
    ...
    sendMessage: (data: any) => apiRequest(API_ENDPOINTS.MESSAGES.SEND, {
      method: 'POST',
      body: JSON.stringify(data),
    }),
